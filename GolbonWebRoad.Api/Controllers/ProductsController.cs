...
namespace GolbonWebRoad.Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] GetProductsQuery query)
        {
            ...
            _cache.Set(cacheKey, productDtos, productCacheOptions);
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetById(int id, [FromQuery] bool joinCategory = false, [FromQuery] bool joinImages = true, [FromQuery] bool joinBrand = true)
        {
        ...
        public async Task<IActionResult> Create([FromForm] CreateProductRequestDto request)
        {
            ...
            _logger.LogInformation("محصول با شناسه {ProductId} توسط ادمین {AdminId} با موفقیت ایجاد شد.", productId, adminId);
